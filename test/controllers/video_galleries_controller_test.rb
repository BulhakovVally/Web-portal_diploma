...
class VideoGalleriesControllerTest < ActionController::TestCase
  ...
  test "should create video_gallery" do
    assert_difference('VideoGallery.count') do
      post :create, video_gallery: { describtion: @video_gallery.describtion, name: @video_gallery.name, video: @video_gallery.video }
    end
  ...
  test "should update video_gallery" do
    patch :update, id: @video_gallery, video_gallery: { describtion: @video_gallery.describtion, name: @video_gallery.name, video: @video_gallery.video }
    assert_redirected_to video_gallery_path(assigns(:video_gallery))
  end
